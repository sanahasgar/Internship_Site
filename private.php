...
?>
    ...
    <div class="max-width-container">
            ...
            <section>
                ...
                <p>
                <ul>
                    <li><a href="https://www.google.com/policies/privacy/" target="_blank">Google Sign In and YouTube</a></li>
            ...
            <section>
                <p>
                    <b>Information about your contacts:</b> When you choose to share content on Internshala with friends using the Google+ share feature and sign in using your Google account, we may collect, process and store information of the contacts (email addresses of contacts) associated with your Google account. Also, when you share content with your friends through SMS share option on Internshala, we may collect, process and store information of the contacts (phone numbers) to whom you choose to send the SMS.

                </p>
                <p>
                    <b>Information collected through use of service:</b> We also gather or may gather certain information about your use of our Services, such as what areas you visit and what features you access. Moreover, there is information about your computer hardware and software that is or may be collected by us. This information can include without limitation your IP address, browser type, domain names, access times and referring website addresses and can be used by Internshala as it deems fit.
            ...
            <ul>
                <li>
                    If you are an employer, information related to your internship post such as organisation name, URL, and description, internship description, skills required etc. is published online and can be viewed by anyone visiting Internshala site and app. This information may also appear in search websites like Google. Further, we may share your personal information (including contact details) with students who apply to your internships or get hired by you through Internshala.
                </li>
                <li>
                    If you are an applicant, we may share your personal information with employers whose internships you apply to or whose internships we feel may be relevant for you or who may come across your profile through a search of our user base.
                </li>
                <li>
                    We may share your information with third party individuals, contractors, companies and other service providers that perform services on our behalf or in partnership with us. For example, we may require to pass on your data to a partner who might be responsible for the delivery of a training program that you may have voluntarily signed up for.
                </li>
                <li>
                    Additionally, you may have the option to share your information and activities on Internshala through social media. We do not have control over information shared with third party social networks and you should review the policies of those networks before consenting to share information with them.
                </li>
                <li>
                    If you post any of your personal information in public areas of Internshala, such as in online forums, chat rooms, comments section etc. this information will be accessible to everyone on the public internet. It may be collected and used by others over whom Internshala has no control. We are not responsible for the use made by third parties of information you post or otherwise make available in public areas of this website.
                </li>
                <li>
                    When we send you an email or SMS, we use a third party service. In this case, it becomes necessary to pass on your email address/ mobile number to the third party. While we only work with reputed service providers in this regard, we are not responsible for the use made by them of this information.
                </li>
                <li>
                    Internshala reserves the right to publish the internship post of companies on social media platforms and 3rd party websites like LinkedIn, Indeed, Sheroes, Qween, etc., along with newspapers and magazines, in order to increase the visibility of the internship post.
                </li>
                <li>
                    We may also share your information in order to investigate, prevent, or take action about possible illegal activities or to comply with legal process. We may also share your information with third parties to investigate and address violations of this Privacy Policy or the Terms of Service, or to investigate and address violations of the rights of third parties and/or Internshala, our employees, users, or the public. This may involve the sharing of your information with law enforcement, government agencies, courts, and/or other organizations.
                </li>
            </ul>
            ...
            <p>
                Our customer support team will be happy to help you with this. Please write to us at <a href="mailto:privacy@internshala.com">privacy@internshala.com</a>.
            </p>

            <h4>Communication policy</h4>
            <h5>For opt-in</h5>
            <p>
                For a user to receive our weekly newsletter, student/employer digests and/or any other marketing communication from us over email; Internshala follows a double opt-in policy where after submitting your email address you need to verify it by clicking on a verification link that we would send to you over given email address. Until the email is verified, you would not receive the newsletter or any marketing communication from us.
            </p>

            <h5>For opt-out</h5>
            <p>
                <b>Marketing/ Digests/ Newsletter:</b> Every newsletter and promotional communication from Internshala contains an 'Unsubscribe' link that you can click on to stop receiving any future newsletters and promotional content from us on your email. It may take upto 7 days for your unsubscription request to be processed.
            </p>
            <p>
                <b>Transactional:</b> We require to send users transactional communication as this is required for proper functioning of our service. If you wish to discontinue receiving any transactional communication from Internshala, write to us at <a href="mailto:privacy@internshala.com">privacy@internshala.com</a>.
            </p>
            ...
            <h4>GDPR entitlement</h4>
            <p>
                EU General Data Protection Regulation (GDPR) has provided the below rights to the EU residents:
            </p>
            <ul>
                <li>Right to information - the purposes for processing Personal Information and the rights of the individual.</li>
            ...
            <p>
                EU residents can exercise these rights by raising a request directly at <a href="mailto:privacy@internshala.com">privacy@internshala.com</a>.
            </p>
